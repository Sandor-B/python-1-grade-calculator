...
StudentGrade = (AmountOfLabs * 3.333) + (AmountOfQuizzes * 3) + (Assignment1 * 0.04) + (Assignment2 * 0.04) + (Assignment3 * 0.04) + (Assignment4 * 0.04) + (Midterm1 * 0.125) + (Midterm2 * 0.125) + (FinalExam * 0.18) + (FinalMidtermPreparations * 0.06)
